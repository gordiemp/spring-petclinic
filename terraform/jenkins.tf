module "jenkins" {
  ...
  repository-test-url    = aws_ecr_repository.spring-petclinic.repository_url
  repository-staging-url = aws_ecr_repository.spring-petclinic-staging.repository_url
  instance-id            = module.deployment-server.instance-id
  ...
  bucket-logs-name       = aws_s3_bucket.spring-petclinic-logs.id
